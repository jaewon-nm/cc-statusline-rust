...
> Last updated: 2026-05-14 (M3 preview-diff + M4 color **✅ completed** — `preview --diff` JSON envelope, `config color` subcommand, NO_COLOR / FORCE_COLOR / CLICOLOR_FORCE honored, **123/123 tests pass**, default-theme snapshot unchanged.)
